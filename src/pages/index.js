                        ...
                        <div style={{textAlign: "left", flex: 1, padding: "0 2rem"}}>
                            ...
                            <div style={{display: "flex", gap: "1rem", flexWrap: "wrap"}}>
                                ...
                                <a
                                    ...
                                    style={{
                                        backgroundImage: "linear-gradient(135deg, #5f87ff, #44b8ff, #37d7c7)",
                                        color: "white",
                                        padding: "0.75rem 1.5rem",
                                        borderRadius: "999px",
                                        fontSize: "1rem",
                                        fontWeight: "bold",
                                        textDecoration: "none",
                                        boxShadow: "0 4px 10px rgba(55, 135, 255, 0.28)",
                                        transition: "all 0.3s ease",
                                        border: "none",
                                    }}
                                    onMouseEnter={(e) => {
                                        e.target.style.transform = "translateY(-2px)";
                                        e.target.style.boxShadow = "0 8px 18px rgba(55, 135, 255, 0.4)";
                                        e.target.style.filter = "brightness(1.05)";
                                    }}
                                    onMouseLeave={(e) => {
                                        e.target.style.transform = "translateY(0)";
                                ...
                                <a
                                    ...
                                    style={{
                                        ...
                                        backgroundImage:
                                            "linear-gradient(#fff, #fff), linear-gradient(135deg, #996dff, #7f8cff, #4e8dff)",
