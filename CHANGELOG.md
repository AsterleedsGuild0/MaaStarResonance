...
- 合并提交 - 新增环城载具赛功能和其他调整优化 (#92) @azmiao
- 新增环城载具赛功能实现 @azmiao
...
- 优化载具赛输入逻辑 @azmiao
- 载具赛新增队伍类型选项和等待时长设置 @azmiao
- 优化载具赛的流程逻辑，防止进入省电模式 @azmiao
...
- MaaFw更新至v5.10.0 @azmiao

### 🔁 还原提交

- Revert "perf🚀: 优化载具赛的流程逻辑，防止进入省电模式" @azmiao
...
- 新增游星岛 浪花躲避球、极限落潮、镭射回旋 小游戏支持 (#91) @azmiao
- 新增游星岛镭射回旋小游戏 @azmiao
- 新增游星岛极限落潮小游戏 @azmiao
- 新增游星岛浪花躲避球小游戏 @azmiao
